...
import { bip39, hdkey, EncryptOptions, getAddress, generatePrivateKey } from '@nordicenergy-js/crypto';
import { Messenger } from '@nordicenergy-js/network';
import { isPrivateKey, isAddress, ChainType } from '@nordicenergy-js/utils';
...
class Wallet {
   ...
   * const { HttpProvider, Messenger } = require('@nordicenergy-js/network');
   * const { ChainType, ChainID } = require('@nordicenergy-js/utils');
   *
  ...
  addByMnemonic(phrase: string, index: number = 0) {
    ...
    // TODO:hdkey should apply to Nordic Energy's settings
    const path = this.messenger.chainType === ChainType.NordicEnergy ? '1023' : '60';
   ...
   * const key_1 = '45e497bd45a9049bcb649016594489ac67b9f052a6cdf5cb74ee2427a60bf25e';
   * wallet.addByPrivateKey(key_1);
   * wallet.encryptAccount('net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7', '12345').then((value) => {
   *   console.log(value);
   * })
   * ```
   */
   ...
   * const key_1 = '45e497bd45a9049bcb649016594489ac67b9f052a6cdf5cb74ee2427a60bf25e';
   * wallet.addByPrivateKey(key_1);
   * wallet.encryptAccount('net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7', '12345')
   * .then(() => {
   *   wallet.decryptAccount('net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7', '12345')
   *   .then((value) =>{
   *      console.log(value);
   *   });
   * });
   ...
   * const key_1 = '45e497bd45a9049bcb649016594489ac67b9f052a6cdf5cb74ee2427a60bf25e';
   * wallet.addByPrivateKey(key_1);
   * console.log(wallet.getAccount('net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7'));
   * ```
   */
   ...
   *   ChainType.NordicEnergy, // if you are connected to Nordic Energy's blockchain
   *   ChainID.NetLtocal, // check if the chainId is correct
   * )
