...
import { Transaction, RLPSign } from '@nordicenergy-js/transaction';
import { StakingTransaction } from '@nordicenergy-js/staking';
import { Messenger, RPCMethod } from '@nordicenergy-js/network';
...
class Account {
   ...
   * const { Account } = require('@nordicenergy-js/account');
   *
   ...
   *   ChainID.NetLocal, // check if the chainId is correct
   * )
   *
   * // setMessenger later
  ...
  async signTransaction(
    ...
    if (updateNonce) {
      ...
      transaction.setParams({
        ...
        from:
          this.messenger.chainPrefix === ChainType.NordicEnergy
            ? this.bech32Address
   ...
   *
   * > net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7-0
   * ```
   */
