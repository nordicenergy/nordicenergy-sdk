 ...
 * @module nordicenergy-crypto
 */

import { isAddress, isBech32Address, isBech32TestNetAddress } from '@nordicenergy-js/utils';
 ...
 * const { NordicEnergyAddress } = require('@nordicenergy-js/crypto');
 *
 * // Step 2: call functions
 * const addr = 'net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7'
 * const res = NordicEnergyAddress.isValidBech32(addr);
 * console.log(res);
 * ```
 */
export class NordicEnergyAddress {
  /**
   * @example
   * ```
   * const addr = 'net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7'
   * const res = Address.isValidBech32(addr);
   * console.log(res);
   * ```
   */
  static isValidBasic(str: string) {
    const toTest = new NordicEnergyAddress(str);
   ...
   * ```
   * const addr = 'net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7'
   * const res = NordicEnergyAddress.isValidChecksum(addr);
   * console.log(res);
   * ```
   */
   ...
   * ```
   * const addr = 'net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7'
   * const res = NordicEnergyAddress.isValidBech32TestNet(addr);
   * console.log(res);
   * ```
   */
   ...
   * ```
   * const addr = 'net103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7'
   * const instance = new NordicEnergyAddress(addr);
...
/**
 * Using this function to get Nordic Energy format address
 *
 * @param address
 *
 * @example
 ...
 * const hAddress = net.crypto.getAddress(bytes);
 * console.log(hAddress)
 * ```
 */
export function getAddress(address: string) {
  try {
    return new NordicEnergyAddress(address);
  } catch (error) {
    throw error;
  }
}
