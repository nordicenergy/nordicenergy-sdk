...
import { toChecksumAddress, randomBytes } from '@nordicenergy-js/crypto';
// tslint:disable-next-line: no-implicit-dependencies
    ...
    const responses = [
      ...
      },
      {
        ...
        result: {
          ...
          from: 'net1z05g55zamqzfw9qs432n33gycdmyvs38xjemyl',
          gasUsed: '0x5208',
          logs: [],
          logsBloom:
          ...
          shardID: 0,
          status: '0x1',
          to: 'net1z05g55zamqzfw9qs432n33gycdmyvs38xjemyl',
