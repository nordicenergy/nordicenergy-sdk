...
*   gasPrice: new net.utils.Unit('1').asGwei().toWei(),
* });
```
...
* const tx = net.transactions.recover(raw);
```
...
*       console.log('');
*       console.log('https://explorer.testnet.nordicenergy.io/#/tx/' + txnHash);
*       console.log('');
*       process.exit();
*     }
*   }
